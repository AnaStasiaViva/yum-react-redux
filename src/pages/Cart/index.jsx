...
const Cart = () => {
  ...
  const plusCartItem = React.useCallback(
    (id) => dispatch(cartActions.plusItem(id)),
    [dispatch]
  );
  const minusCartItem = React.useCallback(
    (id) => dispatch(cartActions.minusItem(id)),
    [dispatch]
  );
            ...
            <div class="content__items">
              {map(items, ([item]) => (
                <CartItem
                  key={item.id}
                  {...item}
                  onReduce={() => minusCartItem(item.id)}
                  onIncrease={() => plusCartItem(item.id)}
